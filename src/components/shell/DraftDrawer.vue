<template>
  <CdDrawerOrSheet v-if="ui.draftDrawer" :presentation="isDesktop ? 'drawer' : 'sheet'" width="min(440px, 46%)" scrim-color="var(--cd-scrim)" sheet-fullscreen sheet-surface="var(--cd-surface-textured)" @scrim-click="close" @dismiss="close">
    <CdDraftDrawer
      :groups="groups"
